...
function GuestRoom() {
  ...
  const { data, loading, error } = useFetch(`${URL}/home/find/${id}`);

  const { user } = useContext(AuthContext);

  const { dates, options } = useContext(SearchContext);

  // To find how many days difference in dates
          ...
          <div className='hotelWrapper'>
            ...
            <div className='hotelDetails'>
              ...
              <div className='hotelDetailsPrice'>
                <h1>
                  Perfect for a {days}-night stay! You can stay minimum{' '}
                  {data.minStay} day and maximum {data.maxStay} days.
                </h1>
                <span>
